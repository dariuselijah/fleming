...
function printConfig(url: string) {
  ...
  console.log(`   WhatsApp Inbound:  ${url}/api/comms/whatsapp/webhook`)
  console.log(`   WhatsApp Status:   ${url}/api/comms/whatsapp/status`)
  console.log(`   Voice Inbound:     ${url}/api/comms/voice/webhook`)
  console.log(`   Health Check:      ${url}/api/comms/whatsapp/webhook/health\n`)
